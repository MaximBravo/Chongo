...
public class MyAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void setAlarm(Context context) {
        ...
        Intent intent = new Intent(context, MyPostNotificationReceiver.class);
...
//        calendar.set(Calendar.MINUTE, 33);
        ...
        alarmMgr.set(AlarmManager.RTC_WAKEUP, futureInMillis, alarmIntent);
...
//                AlarmManager.INTERVAL_FIFTEEN_MINUTES, alarmIntent);
        alarmMgr.setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP, futureInMillis, Utils.frequency * 60000, alarmIntent);
